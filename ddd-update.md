...
7. **⚠ VOCABULARY GATE — verify before writing EACH node (see Usage Guide § DDD Vocabulary Reference):**
...
8. **Apply the changes to the YAML specs** (**SPEC FILES ONLY — never edit implementation code**):

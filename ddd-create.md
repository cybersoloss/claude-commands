...
13. **Create flow YAML files**: **Do NOT delegate flow generation to subagents or background agents.** Generate each flow YAML directly in this session — subagents don't have the Usage Guide, skeleton template, or vocabulary gate in their context, which causes structural format divergence. Write each flow sequentially.
